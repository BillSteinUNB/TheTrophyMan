  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-black/10 bg-gradient-to-b from-black/50 via-black/40 to-black/60" />
      </div>
      ...
      <div className="relative z-10 container-max text-center pt-20">
        <div className="max-w-4xl mx-auto animate-fade-up">
          {/* Headline */}
          <h1 className="text-display text-white mb-6 tracking-tight drop-shadow-xl">
          ...
          {/* Subhead */}
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed drop-shadow-lg">
